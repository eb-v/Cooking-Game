        ...
        if (PlayerIsMissingParts())
        {
            ...
            if (leftHandGD.grabbedObj != null)
            {
                ...
                if (CheckForJointObjMatch(rootGrabbedObj))
                {
                    ...
                    ConnectJoint(rootGrabbedObj, storedJointData[rootGrabbedObj]);
                }
                else
                {
            ...
            //    if (CheckForJointObjMatch(rootGrabbedObj))
            //    {
            //        JointBackup jointBackup = storedJointData[rootGrabbedObj];
            //        ConnectJoint(rootGrabbedObj, jointBackup);

            //        storedJointData.Remove(rootGrabbedObj);

            //        SetTagRecursively(rootGrabbedObj, "Untagged");
            //    }

            //}
            //else if (rightHandGD.grabbedObj != null)
            //{
            //    GameObject rootGrabbedObj = rightHandGD.grabbedObj.transform.root.gameObject;
            //    if (CheckForJointObjMatch(rootGrabbedObj))
            //    {
            ...
            //else
            //{
            //    Debug.Log("Other player is not holding any objects.");
            //}
