...
public static class ConfigurableJointExtensions
{
    ...
    public static void SetupAsCharacterJoint(this ConfigurableJoint joint)
    {
        ...
        // Use slerp drive for rotation
        joint.rotationDriveMode = RotationDriveMode.Slerp;

        JointDrive slerpDrive = new JointDrive
        {
            positionSpring = 1000f,  // how strong it tries to reach target rotation
            positionDamper = 100f,   // how much it resists overshooting/oscillation
