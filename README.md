A physics-based multiplayer cooking game built in Unity where chaos meets culinary challenges.

Control ragdoll characters to grab ingredients, operate kitchen stations, complete orders, and deliver dishes—all while managing environmental hazards like conveyor belts, explosive drones, and speeding trains. Features local multiplayer support for up to 4
players with skill-check mini-games and recipe-driven cooking mechanics.
